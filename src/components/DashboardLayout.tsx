...
const navItems = [
  { path: "/dashboard", icon: Plus, label: "New Order" },
  { path: "/dashboard/orders", icon: History, label: "Order History" },
  { path: "/dashboard/add-funds", icon: Wallet, label: "Add Funds" },
  { path: "/dashboard/services", icon: ShoppingCart, label: "Services" },
